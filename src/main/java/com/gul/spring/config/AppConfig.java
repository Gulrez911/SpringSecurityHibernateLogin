...
import com.gul.spring.model.Authorities;
...
@ComponentScans(value = { @ComponentScan("com.gul.spring.dao"),
    @ComponentScan("com.gul.spring.service") })
